# This is the invokes.py from Lab 5: complex microservices
# This python script introduces invoke_http function to call other microservices via http protocols
import requests
